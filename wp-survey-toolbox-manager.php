<link type="text/css" rel="stylesheet" media="screen" href="<?php echo(plugins_url( 'css/survey.css', __FILE__ ));?> ">
<script>	
	var STBroot = "<?php echo plugins_url() . "/wp-survey-toolbox/"; ?>";
	console.log(STBroot);
	console.log("<?php echo(plugins_url( '/js/init/init_survey.js', __FILE__ )); ?>");
</script>
<script data-main="<?php echo(plugins_url( '/js/init/init_survey_manager.js', __FILE__ )); ?>" src="<?php echo(plugins_url( '/js/libs/require.js', __FILE__ ));?>"></script>
